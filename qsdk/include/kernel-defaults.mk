...
INITRAMFS_DIR := $(TARGET_ROOTFS_DIR)/initramfs
...
ifeq ($(CONFIG_TARGET_ROOTFS_INITRAMFS),y)
  ifeq ($(strip $(CONFIG_EXTERNAL_CPIO)),"")
	...
	echo 'CONFIG_INITRAMFS_SOURCE="$(strip $(INITRAMFS_DIR) $(INITRAMFS_EXTRA_FILES))"' >> $(LINUX_DIR)/.config
    endef
  else
    define Kernel/SetInitramfs/PreConfigure
  ...
  define Kernel/SetInitramfs
	...
	$(TOPDIR)/include/initramfs.sh $(TARGET_DIR) $(INITRAMFS_DIR)
...
define Kernel/CompileImage/Initramfs
	...
	$(CP) $(GENERIC_PLATFORM_DIR)/base-files/init_ramfs $(INITRAMFS_DIR)/init
